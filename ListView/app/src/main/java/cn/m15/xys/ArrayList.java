...
public class ArrayList extends ListActivity {
    private String[] mListTitle = { "ArrayList1", "ArrayList2", "ArrayList3", "ArrayList4","ArrayList5"};
    private String[] mListStr = { "Name", "Age", "Sex", "Hight", "Weight" };
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		button.setOnClickListener(new OnClickListener() {
			...
			Toast.makeText(arrayList,"This is Arraylist Toast"+position +"This is arraylist Toast", Toast.LENGTH_LONG).show();
